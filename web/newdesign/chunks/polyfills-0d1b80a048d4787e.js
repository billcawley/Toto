!(function () {
    ...
    var Ue = { IteratorPrototype: Ee, BUGGY_SAFARI_ITERATORS: Le },
        ...
        _e = qt("toStringTag"),
        Ne = function (t, e, r) {
            t && !w((t = r ? t : t.prototype), _e) && Me(t, _e, { configurable: !0, value: e });
        },
        Ce = {},
        ...
        Ye = function (t, e, r, n, o, i, a) {
            ...
            if (
                (g &&
                    ...
                    We !== Object.prototype &&
                        u.next &&
                        (Te(u) !== We && (ze ? ze(u, We) : "function" != typeof u[Ge] && T(u, Ge, Xe)), Ne(u, l, !0))),
                o == Ve &&
                    d &&
                    d.name !== Ve &&
                    ((h = !0),
    ...
    var Ur = !o(function () {
        ...
        Fr = function (t, e, r) {
            ...
            return (l[t] = f), Lt({ global: !0, forced: f != s }, l), Ne(f, t), a || r.setStrong(f, t, i), f;
        },
        Br = function (t, e, r) {
    ...
    Lt(
        ...
        Lt(
            ...
            {
                merge: function (t) {
                    for (var e = j(this), r = Zt(e.set), n = 0; n < arguments.length; ) _r(arguments[n++], r, e, !0);
                    return e;
                },
            },
        ),
    ...
    var bo = {
            getConstructor: function (t, e, r, n) {
                var o = t(function (t, i) {
                        Nr(t, o, e), fo(t, { type: e, id: vo++, frozen: void 0 }), null != i && _r(i, t[n], t, r);
                    }),
                    i = lo(e),
                    a = function (t, e, r) {
                        var n = i(t),
    ...
    var Mo = Fr(
        ...
        Co = function t(e, r) {
            ...
            var i,
                a,
                u = t(o, r);
            return u.length ? (n.length ? ((i = new Mo(n.concat(u))), _r(i, (a = []).push, a), a) : u) : n;
        };
    Lt(
        { target: "Reflect", stat: !0 },
        {
    ...
    if (
        ...
        for (
            var hi = function (t, e) {
                    ...
                    fi ? o && !i && (t = t.source) : t instanceof hi && (i && (e = Jo.call(t)), (t = t.source)),
    ...
    Lt({ target: "RegExp", proto: !0, forced: /./.exec !== Oi }, { exec: Oi }),
        i && ("g" != /./g.flags || ei.UNSUPPORTED_Y) && I.f(RegExp.prototype, "flags", { configurable: !0, get: Jo });
    var Ri = et.get,
        ji = RegExp.prototype;
    i &&
        ei.UNSUPPORTED_Y &&
            ...
            if (!a || !u || ("replace" === t && (!Ui || !Mi || Ni)) || ("split" === t && !Ci)) {
                var s = /./[i],
                    c = r(
                        ...
                        { REPLACE_KEEPS_$0: Mi, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ni },
                    ),
                    f = c[1];
        ...
        return [
            ...
            function (t, n) {
                ...
                for (var g, y = "", m = 0, b = 0; b < d.length; b++) {
                    v = d[b];
                    for (var w = String(v[0]), S = zi(Wi(st(v.index), f.length), 0), E = [], x = 1; x < v.length; x++)
                        ...
                        ? function (t, r) {
                              ...
                              for (
                                  ...
                                  !(
                                      ...
                                      i.length > 1 && i.index < n.length && Vi.apply(s, i.slice(1)),
                                      (u = i[0].length),
                                      (c = a),
                                      s.length >= o)
                                  );
    ...
    oa
        ...
        : ea && (!(Zi = ea.match(/Edge\/(\d+)/)) || Zi[1] >= 74) && (Zi = ea.match(/Chrome\/(\d+)/)) && (ta = Zi[1]);
    var ia = ta && +ta,
        aa = qt("species"),
    ...
    var pa = wt.f,
        ...
        qa = function (t, e) {
            ...
            return Aa(r, { type: Ea, tag: t, description: e }), i || (r.description = e), r;
        },
        za = Ct
            ? function (t) {
        ...
        Wa = function (t, e, r) {
            ...
            return (
                ...
                w(Ua, n)
                    ? (r.enumerable
                          ? (w(t, Sa) && t[Sa][n] && (t[Sa][n] = !1), (r = Xt(r, { enumerable: f(0, !1) })))
    ...
    if (
        ...
        Lt({ target: "Object", stat: !0, forced: !Nt }, { getOwnPropertyNames: Va, getOwnPropertySymbols: Ha }),
        Lt(
            {
                target: "Object",
                stat: !0,
        ...
        var Xa =
            ...
            o(function () {
                var t = ja();
                return "[null]" != Pa([t]) || "{}" != Pa({ a: t }) || "{}" != Pa(Object(t));
            });
        Lt(
    ...
    ja.prototype[xa] || T(ja.prototype, xa, ja.prototype.valueOf), Ne(ja, Ea), (H[Sa] = !0), ba("asyncIterator");
    var Ya = I.f,
        Ja = n.Symbol;
    ...
    var gu =
        ...
        mu = function (t) {
            return function (e, r, n) {
                ...
                return c <= u || "" == s
                    ? a
                    : ((i = gu.call(s, yu((o = c - u) / s.length))).length > o && (i = i.slice(0, o)),
                      t ? a + i : i + a);
            };
        },
    ...
    var Pu = function (t) {
        ...
        ku = Tu
            ...
            : "".trimStart;
    Lt({ target: "String", proto: !0, forced: Tu }, { trimStart: ku, trimLeft: ku }), re("String", "trimLeft");
    var Lu = gn.end,
        Uu = Pu("trimEnd"),
        Mu = Uu
            ? function () {
            ...
            : "".trimEnd;
    Lt({ target: "String", proto: !0, forced: Uu }, { trimEnd: Mu, trimRight: Mu }), re("String", "trimRight");
    var _u = qt("iterator"),
        Nu = !o(function () {
        ...
        hs = function (t, e) {
            if (e)
                for (var r, n, o = e.split("&"), i = 0; i < o.length; )
                    (r = o[i++]).length && ((n = r.split("=")), t.push({ key: us(n.shift()), value: us(n.join("=")) }));
        },
        ps = function (t) {
        ...
        gs = function () {
            ...
            var t,
                ...
                f = this,
                l = [];
            if ((ts(f, { type: Qu, entries: l, updateURL: function () {}, updateSearchParams: ps }), void 0 !== c))
                if (y(c))
                ...
                else hs(l, "string" == typeof c ? ("?" === c.charAt(0) ? c.slice(1) : c) : c + "");
        },
        ys = gs.prototype;
    Br(
        ys,
        {
            ...
            getAll: function (t) {
                ds(arguments.length, 1);
                for (var e = es(this).entries, r = t + "", n = [], o = 0; o < e.length; o++)
                    e[o].key === r && n.push(e[o].value);
                return n;
            },
            has: function (t) {
                ds(arguments.length, 1);
                for (var e = es(this).entries, r = t + "", n = 0; n < e.length; ) if (e[n++].key === r) return !0;
                return !1;
            },
            set: function (t, e) {
                ds(arguments.length, 1);
                for (var r, n = es(this), o = n.entries, i = !1, a = t + "", u = e + "", s = 0; s < o.length; s++)
            ...
            forEach: function (t) {
                for (
                    var e, r = es(this).entries, n = te(t, arguments.length > 1 ? arguments[1] : void 0, 3), o = 0;
                    o < r.length;
                    ...
                    fetch: function (t) {
                        ...
                        return (
                            arguments.length > 1 &&
                                (y((e = arguments[1])) &&
                                    fr((r = e.body)) === Qu &&
                                    ((n = e.headers ? new Yu(e.headers) : new Yu()).has("content-type") ||
    ...
    var ms,
        ...
        Ws = function (t) {
            ...
            for (r = [], n = 0; n < e; n++) {
                ...
                if (
                    ((i = 10),
                    o.length > 1 && "0" == o.charAt(0) && ((i = Ms.test(o) ? 16 : 8), (o = o.slice(8 == i ? 1 : 2))),
                    "" === o)
                )
                    a = 0;
                else {
            ...
            for (
                ...
                switch (((i = o[f]), c)) {
                    ...
                    case mc:
                        if (((t.scheme = "file"), "/" == i || "\\" == i)) c = bc;
                            ...
                            if (i == ms) (t.host = n.host), (t.path = n.path.slice()), (t.query = n.query);
                                ...
                                if ("#" != i) {
                                    rc(o.slice(f).join("")) || ((t.host = n.host), (t.path = n.path.slice()), nc(t)),
                                        (c = Ec);
                                    continue;
                                }
                                (t.host = n.host),
                    ...
                    case Ac:
                        r || "#" != i
                            ? i != ms &&
                              ("'" == i && Qs(t) ? (t.query += "%27") : (t.query += "#" == i ? "%23" : Ys(i, $s)))
                            : ((t.fragment = ""), (c = Oc));
                        break;
                    case Oc:
        ...
        (i &&
            Wt(Pc, {
                ...
                search: qc(Fc, function (t) {
                    ...
                    "" == (t = String(t))
                        ? (e.query = null)
                        : ("?" == t.charAt(0) && (t = t.slice(1)), (e.query = ""), Rc(e, t, Ac)),
                        xs(e.searchParams).updateSearchParams(e.query);
                }),
                searchParams: qc(Bc),
                hash: qc(Dc, function (t) {
                    var e = Os(this);
                    "" != (t = String(t))
                        ? ("#" == t.charAt(0) && (t = t.slice(1)), (e.fragment = ""), Rc(e, t, Oc))
                        : (e.fragment = null);
                }),
            }),
        rt(
    ...
    (Yc && Jc) ||
        ...
        "process" == h(Qc)
            ...
            : Zc && !Hc
            ? (($c = (Gc = new Zc()).port2), (Gc.port1.onmessage = af), (Kc = te($c.postMessage, $c, 1)))
            : !n.addEventListener ||
                        ...
                        try {
                            l
                                ? (i || (2 === e.rejection && nl(t, e), (e.rejection = 1)),
                                  ...
                                  u === f.promise ? p(qf("Promise-chain cycle")) : (s = Qf(u)) ? s.call(u, h, p) : h(u))
                                : p(o);
                        } catch (t) {
                            d && !c && d.exit(), p(t);
                        }
    ...
    (fl.prototype = Xt(Error.prototype, { constructor: f(5, fl), message: f(5, ""), name: f(5, "AggregateError") })),
        i &&
    ...
    function Il(t, e) {
        ...
        if (
            ...
            (this.method = ((n = (r = e.method || this.method || "GET").toUpperCase()), Pl.indexOf(n) > -1 ? n : r)),
    ...
    (Ml.polyfill = !0),
        self.fetch || ((self.fetch = Ml), (self.Headers = El), (self.Request = Il), (self.Response = kl));
