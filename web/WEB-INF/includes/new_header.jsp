...
<!--                        <a class="group <c:if test="${title=='Manage Reports'}">active</c:if>" rel="noopener noreferrer" href="/api/ManageReports?newdesign=true">-->
                    ...
                    >
                        ...
                        <a class="group" rel="noopener noreferrer" href="/api/ManageDatabases/?newdesign=maintenance"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="2"
                        ...
                        <a class="group" rel="noopener noreferrer" href="/api/ManageDatabases?newdesign=pendinguploads"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="2"
                        ...
                        <a class="group" rel="noopener noreferrer" href="/api/ManageDatabases?newdesign=importtemplates"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="2"
                        ...
                        <a class="group" rel="noopener noreferrer" href="/api/ManageDatabaseConnections"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="2"
