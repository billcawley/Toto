...
<script>
    ...
    */
    ...
    var lastValue = "";
    var filters = [];
    var filterHTML = '<span class="close"><span class="fa fa-close" onClick="removeFilter("FILTER")/>FILTERSHOWN</span>'
    changed("", 0);
...
//console.log(data)
    ...
    function showFilters(){
        ...
        filtersHTML += filterHTML.replaceAll("FILTER", filter).replace("FILTERSHOWN", filter);
    }
