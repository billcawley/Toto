...
<div class="az-content">
    <span id="lockedResult"><c:if test="${not empty lockedResult}"><textarea class="public"
                                                                             style="height:60px;width:400px;font:10px monospace;overflow:auto;font-family:arial;background:#f58030;color:#fff;font-size:14px;border:0">${lockedResult}</textarea></c:if></span>
    <div class="az-topbar">
        ...
        <div class="az-topbar-menu">
            <c:if test="${reloadExternal == true}">
                <div class="az-dropdown">
                    <button type="button" aria-haspopup="true" aria-expanded="false"
                            onclick="toggleAutoReloadExternal()">
            ...
            <button id="saveDataButton" <c:if test="${showSave == false}"> style="display:none;"</c:if>
                    class="az-button" type="button" onclick="postAjax('Save'); return false;">
                Save Data
            </button>

            <button id="restoreDataButton" <c:if test="${showSave == false}"> style="display:none;"</c:if>
                    class="az-button" type="button" onclick="postAjax('RestoreSavedValues'); return false;">
            ...
            <div class="az-dropdown">
                <div>
                    <button id="headlessui-menu-button-:r0:" type="button" aria-haspopup="true" aria-expanded="false"
                            onclick="window.open('/api/Jstree?op=new&database=${databaseName}')">
            ...
            <div class="az-dropdown">
                <div>
                    <button id="headlessui-menu-button-:r1:" type="button" aria-haspopup="true" aria-expanded="false"
                            onclick="window.location.assign(window.location.href+='&opcode=template')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                             stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
