...
Private Sub SubmitButton_Click()
   ...
   AttList = """operation"":""edit"",""id"":""" & thisNode.AzquoName("id") & """,""attributes"":{""DEFAULT_DISPLAY_NAME"":""" & azNameValue.value & """"
   ...
   For attNo = 1 To attcount
    ...
    If Left(azReply, 6) <> "error:" Then
        ...
        azName("name") = azNameValue.value
        Dim azAttributes As Object
        Set azAttributes = azName("attributes")
        For Each azAttribute In azAttributes
