...
But can use a library?
                        ...
                        } else if (function==null && !hasCalc && valuesHook.values != null && valuesHook.values.size() == 1 && (!locked.isTrue//if there's only one value, treat it as text (it may be text, or may include £,$,%)
