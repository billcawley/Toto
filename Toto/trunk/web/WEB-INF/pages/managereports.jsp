     ...
     <c:forEach items="${reports}" var="report">
         <tr>
            ...
            <td>${report.businessId}</td>-->
             ...
             <td><a href="/api/Online?reportid=1&amp;opcode=loadsheet&amp;reporttoload=${report.id}&amp;database=${report.database}"> ${report.reportName}</a></td>
             <td><input name="businessType${report.id}" value="${report.databaseType}" size="50"/></td>
