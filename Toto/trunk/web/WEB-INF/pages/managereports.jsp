                ...
                <div class="az-table">
                    <table>
                        ...
                        <c:forEach items="${reports}" var="report">
                            ...
                            <a href="" title="Edit ${report.reportName}" class="button is-small"><span class="fa fa-edit" title="Edit"></span></a>
                            </td>-->
                            <tr>
                                    ...
                                    <div class="az-actions">
                                        <div>
                                            ...
                                            <button id="headlessui-menu-button-:rb:" type="button" aria-haspopup="true"
                                                    aria-expanded="false" onclick="showHideDiv('submenu${report.id}')">
                                            ...
                                            <div class="az-actions-items transform opacity-100 scale-100"
                                                 aria-labelledby="submenu${report.id}"
                                                 id="submenu${report.id}" role="menu" tabindex="0" style="display: none"><span
                                                    role="none"><div id="headlessui-menu-item-:rs:" role="menuitem"
                                                                     tabindex="-1"><svg
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor" aria-hidden="true"><path
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg><a
                                                    href="/api/ManageReports?editId=${report.id}">Open</a></div></span><span role="none"><div
                                                    id="headlessui-menu-item-:rt:" role="menuitem" tabindex="-1"><svg
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor" aria-hidden="true"><path
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg><a
                                                    href="/api/DownloadTemplate?reportId=${report.id}">Download</a></div></span><span
                                                    role="none"><hr role="none"></span><span role="none"><div
                                                    id="headlessui-menu-item-:ru:" role="menuitem" tabindex="-1"><svg
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor" aria-hidden="true"><path
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    href="/api/ManageReports?deleteId=${report.id}" onclick="return confirm('Are you sure you want to delete ${report.reportName}?')" >Delete</a></div></span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
<!--                    <nav>
                        <div>
                            <p>
                                Showing <strong>1</strong> to <strong>10</strong> of <strong>11</strong>
                                reports
                            </p>
                        </div>
                        <div>
