...
public class DefaultDisplayNameValuesSetChildrenSet implements DefaultDisplayName, ValuesSet, ChildrenSet {
    ...
    public DefaultDisplayNameValuesSetChildrenSet(String defaultDisplayName, Value[] values, Set<Name> children) {
        this.defaultDisplayName = defaultDisplayName;
    ...
    public DefaultDisplayNameValuesSetChildrenSet(String defaultDisplayName, Set<Value> values, Name[] children) {
        this.defaultDisplayName = defaultDisplayName;
        this.values = values;
