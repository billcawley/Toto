        ...
        if (loggedInUser == null || !loggedInUser.getUser().isAdministrator()) {
            ...
            if (submit != null) {
                ...
                if (error.length() == 0) {
                    ...
                    Business newBusiness = AdminService.registerBusiness(emailUsername, businessName, password, businessName, address1, address2, address3, address4, postcode, telephone, website, b.getBannerColor(), b.getRibbonColor(), b.getRibbonLinkColor(), b.getSideMenuColor(), b.getSideMenuLinkColor(), b.getLogo());
